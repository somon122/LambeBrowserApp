...
public class Speed_DB_Helper  extends SQLiteOpenHelper {

    private Context context;

    public static final String DB_NAME = "Speed_db";
    public static final int VERSION = 1;

    public static final String VISITED_TABLE = "Speed_Details";
    ...
    public Speed_DB_Helper(Context context) {
