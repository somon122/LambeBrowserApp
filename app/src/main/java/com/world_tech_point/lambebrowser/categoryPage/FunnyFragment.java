...
public class FunnyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_funny, container, false);

        recyclerView = root.findViewById(R.id.categoryFunnyRecyclerView);
