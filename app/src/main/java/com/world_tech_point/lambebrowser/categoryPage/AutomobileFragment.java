...
public class AutomobileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_automobile, container, false);

        recyclerView = root.findViewById(R.id.categoryAutoMobileRecyclerView);
    ...
    private void blogList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Params.put("category", "Automobile");
                return Params;
            }
        };
